...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    abstract: [
      ...
      "Water is managed by demand rather than calendar, targeting roughly 30% water-filled and 70% air-filled soil pores. Years 1-2 rely on shallow furrow irrigation guided by leaf-wilt observation and a soil-ball moisture test at 4 inches depth; from year 3 onward the system is meant to run rain-fed, with supplemental water only in extreme drought. No synthetic fertilizers, herbicides, or pesticides are used at any stage; weeds are suppressed by mulch and, after canopy closure in years 2-3, by shade, while bamboo's natural resilience combined with a balanced soil ecosystem is described as requiring no pest intervention.",
