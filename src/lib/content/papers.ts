...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    keyTakeaways: [
      ...
      "A single sanctioned transitional exception exists: 4 kg Nitrophos (NP 20+20%) per acre through the furrows, or a 2% foliar spray with citric acid, permitted for a maximum of one or two applications only during the first 1-2 crop cycles.",
  ...
  },
  {
    ...
    keyTakeaways: [
      ...
      "For an 18-inch furrow top with slanted sides, the paper specifies an 11-inch tyre as the best fit, with 13 inches as an acceptable fallback; 16-inch tyres are judged too wide and cause excessive sidewall compaction.",
  ...
  },
  {
    ...
    abstract: [
      "The paper states its purpose plainly: PQNK is a closed-loop methodology that first regenerates degraded land through a defined four-step process, after which it enters a sustainable state requiring minimal human intervention, explicitly designed to reverse degenerative practices and build a resilient, self-maintaining agro-ecosystem. Its core contribution is a sequencing claim rather than a new technical detail: degenerative, regenerative, and sustainable are not three competing approaches to choose between, but three sequential stages of a single system.",
      "The regenerative process is restated in its now-familiar four steps: breaking the hardpan to allow deep water and root infiltration; correcting soil chemistry using deep irrigation with sulfuric acid where pH exceeds 8, to leach salts and unlock minerals within the closed-loop system; building permanent raised beds and planting Jantar (Sesbania) as a deep-rooted cover crop to further fracture subsoil, create bio-channels, and mine nutrients; and retaining Jantar roots while chopping its biomass as mulch, then planting cash crops directly into that mulch with a no-till planter, preserving the restored soil structure.",
      "Once this process is complete, the paper states the system enters its sustainable state and no longer degrades over time, requiring only two ongoing human actions, vertical seed placement and harvesting, with no irrigation, fertilization, or tillage needed, since the system maintains itself through natural water cycles (rain, dew, humidity) and a buffered ecosystem supported by fungal networks.",
      "The paper's summary section makes its sequencing argument explicit: degenerative is named the unsustainable starting point, regenerative (the PQNK process) is the intentional four-step rehabilitation, and sustainable (the PQNK state) is the final, low-input, perpetual steady state that results, a framing intended to correct what it calls the common misconception of treating 'regenerative' and 'sustainable' as parallel, interchangeable choices rather than as process and outcome within a single system.",
    ...
    keyTakeaways: [
      ...
      "Restates the four-step PQNK regenerative process: break the hardpan, correct soil chemistry with acid-assisted leaching, build permanent beds and plant Jantar, then retain, mulch, and no-till plant.",
      "Defines the resulting sustainable state as requiring only two human actions indefinitely: seed placement and harvesting, with no irrigation, fertilization, or tillage needed.",
      "Frames 'degenerative' as the unsustainable starting point, 'regenerative' as the intentional four-step rehabilitation, and 'sustainable' as the resulting low-input steady state.",
      "Attributes the sustainable state's self-maintenance to natural water cycles (rain, dew, humidity) and fungal-network-buffered soil ecology rather than ongoing management.",
  ...
  },
  {
    ...
    keyTakeaways: [
      ...
      "Introduces 'ACI' (Ancient-Conventional-Industrial) as one continuous paradigm, naming plough-driven soil inversion, not disturbance in general, as the actual point of ecological disconnection.",
  ...
  },
  {
    ...
    keyTakeaways: [
      ...
      "2002–2008: years of institutional resistance interrupted operations; reflection during that period, not literature review, is what led directly to PQNK.",
  ...
  },
  {
    ...
    keyTakeaways: [
      ...
      "The paper's central caution is that over-watering, not under-watering, is the most common cause of weak, pest-attracting over-vegetation; water only when leaves show slight afternoon wilting.",
    ],
  },
  {
  ...
  },
  {
    ...
    summary:
      "Sets out PQNK's core moisture benchmark, 30% water-filled and 70% air-filled soil pore space, and the yield, input-cost, and produce-quality consequences of over-irrigating past it.",
    publishedDate: "2026-08-04",
    pdfPath: "/papers/soil-moisture-management-in-pqnk-organic-farming.pdf",
    heroImage: "/images/beds-wet-skyline.jpg",
    abstract: [
      "This paper defines the 30/70 Rule as PQNK's central soil-moisture benchmark: pore space should be roughly 30% filled with water and 70% filled with air, a balance it presents as the precise condition needed for beneficial soil microorganisms and healthy root development to coexist.",
      "Maintaining this balance is tied to several compounding benefits: an approximately 90% reduction in water usage compared to conventional irrigation once hardpan-free, well-structured soil allows water to infiltrate efficiently to where it is needed; elimination of chemical fertilizer need, since the resulting thriving microbial ecosystem converts existing soil minerals into plant-available forms; and natural pest protection, as Bacillus thuringiensis populations flourish under these aerated conditions and produce proteins toxic to common pests while remaining harmless to the crop and beneficial insects.",
      ...
      "Practical furrow-irrigation guidance follows directly from the rule: check soil moisture before irrigating, factor in recent rainfall, observe plant stress indicators, and default toward less water rather than more, since hardpan-free beds with organic mulch cover are described as already providing natural pathways for adequate infiltration and aeration without supplemental flooding.",
    ],
    keyTakeaways: [
      "The 30/70 Rule is PQNK's core soil-moisture target: roughly 30% of pore space water-filled, 70% air-filled, calibrated for simultaneous microbial and root health.",
      "Maintaining this balance is associated with an approximately 90% reduction in irrigation water use versus conventional methods once hardpan is broken and beds are well-structured.",
  ...
  },
  {
    ...
    abstract: [
      ...
      "Irrigation guidance follows the PQNK principle that water is a nutrient carrier and evaporative coolant, not a variable to be increased or decreased independently of plant demand: watermelon, described as a desert plant with minimal water needs, may require no irrigation at all on a well-matured PQNK bed, and the standard rule of watering only once the plant begins to wilt is stated to apply to watermelon exactly as it does to any other crop.",
    ],
    keyTakeaways: [
      ...
      "Watermelon is treated as a desert plant with minimal water demand; on a well-matured PQNK bed it may need no supplemental irrigation, following the same wilt-triggered watering rule as any other crop.",
