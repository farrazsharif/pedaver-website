...
| 9+ | — | — | With external reviewers, not web-published | Chapters 9–12 (`ancient-conventional-industrial-aci`, `the-industrialization-of-agriculture`, `the-68-year-experiment`, `captured-science`) are manuscript-final and out to external reviewers; not yet prepared for web publication. Ch 8–12 all use the "68-year (1958–2026)" framework and reference later chapters by title. |
...
**Part One (Chapters 1–7) and Chapter 8 (opening Part Two) are published
and LIVE.** Chapter 8 shipped 2026-09-09 (commit `8a3a3a6`).
...
Chapters 9–12 are manuscript-final and with external reviewers; not yet in
