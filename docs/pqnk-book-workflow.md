...
- **2026-09-11 — Ch15/Ch12 "Captured Science" overlap: cross-reference added,
  ...
  **PDF still needs re-export** — same open item as the rest of the Ch14/15
  pass (see §4, chapter-status row for Chapters 11+).
